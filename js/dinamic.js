...
//Добовляем кнопки управления к комментам на динамике
        function addReviewsController() {
            ...
            for (var i = 0; CommentCount > i; ++i) {
                if (i == 0) {
                    $('#reviews-controller').append('<li data-target="#comment-carousel" data-slide-to="' + i + '" class="active"></li>');
                } else {
                    $('#reviews-controller').append('<li data-target="#comment-carousel" data-slide-to="' + i + '"></li>');
                }
